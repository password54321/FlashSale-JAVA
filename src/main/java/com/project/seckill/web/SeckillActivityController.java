...
public class SeckillActivityController {
    ...
    public ModelAndView seckillCommodity(@PathVariable long userId, @PathVariable long seckillActivityId) {
        ...
        try {
            ...
            if (redisService.isInLimitMember(seckillActivityId, userId)) {
                //user is in the list, can not buy again
                modelAndView.addObject("resultInfo", "sorry, you have an existing order");
            ...
            if (stockValidateResult) {
                ...
                modelAndView.addObject("resultInfo","Success，creating your order，order ID：" + order.getOrderNo());
            ...
            modelAndView.addObject("resultInfo","Something went wrong");
        }
        modelAndView.setViewName("seckill_result");
        return modelAndView;
    }
    ...
    public ModelAndView orderQuery(@PathVariable String orderNo) {
        log.info("check the order status，order ID：" + orderNo);
